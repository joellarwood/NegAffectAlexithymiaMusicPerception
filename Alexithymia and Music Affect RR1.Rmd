...
---
  ...
  A key area in the process of constructing an instance of affect into an emotion is the left temporal pole, which stores conceptual information. Patients with localised damage to this reigon are unable to organise faces into emotional categories but are able to accurately sort the faces according to their affective quality [@lindquist2014]. However, the left temporal pole has not been implicated in neurological studies of alexithymia whereas other areas relevant to affect processing have [@Goerlich-Dobre2015; @vandervelde2013]. A systematic review of neural activation during stimuli presentation has revealed that higher scores on alexithymia are related to increased cognitive demand (higher anterior cingulate gyrus activation), decreased attention to negative stimuli (reduced amygdala activation), and reduced activation of interoceptive networks during positive stimuli presentation [@vandervelde2013]. Keeping within constructionist theory, these results suggest that the on-line processing of emotions 
